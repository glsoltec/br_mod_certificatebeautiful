...
$string['autotrigger_coursecompletion'] = 'Course completion';
$string['autotrigger_gradethreshold'] = 'Minimum final course grade';
$string['autotrigger_required'] = 'You must choose an automatic generation trigger.';
$string['best'] = 'Best';
...
$string['delete-page'] = 'Delete this page from the certificate';
$string['deletedmodel'] = 'The model "{$a}" has been deleted successfully.';
$string['deletemodelconfirm'] = 'Do you really want to delete the model <strong>{$a}</strong>?';
...
$string['gradepass'] = 'Minimum final course grade';
$string['gradepass_required'] = 'You must define a numeric minimum final course grade.';
...
$string['notification_body'] = 'Hello {$a->fullname},<br><br>Your certificate <strong>{$a->certificatename}</strong> for the course <strong>{$a->coursename}</strong> is now available.<br><br>Access it here: <a href="{$a->url}">{$a->url}</a>';
...
$string['report_finalgrade'] = 'Final course grade';
...
$string['triggercmid_required'] = 'You must choose an activity for the activity completion trigger.';
...
$string['deletesignature'] = 'Delete signature';
$string['erroropenssl'] = 'OpenSSL error: {$a}';
$string['errorreadingpfx'] = 'Error reading the PFX/P12 certificate. Check the password.';
$string['invalidfont'] = 'Invalid font.';
$string['invalidtext'] = 'Invalid text.';
$string['mysignature'] = 'My Signature';
$string['notconfigured'] = 'Digital signing is not configured. Upload a PFX certificate in the settings.';
$string['savesignature'] = 'Save signature';
$string['signaturedeleted'] = 'Signature deleted.';
$string['signaturesaved'] = 'Signature saved.';
$string['signaturetext'] = 'Your signature text';
$string['signaturetext_help'] = 'Enter how your name should appear in the signature.';
$string['sign_autosign'] = 'Enable automatic digital signing';
$string['sign_autosign_help'] = 'When enabled, certificates are signed immediately upon generation and the scheduled task processes pending certificates.';
$string['sign_certexpired'] = 'This certificate has expired!';
$string['sign_certinfo'] = 'Digital Certificate Info';
$string['sign_certinfo_cn'] = 'Owner (CN)';
$string['sign_certinfo_help'] = 'Information extracted from the uploaded certificate after successful validation.';
$string['sign_certinfo_issuer'] = 'Issuer';
$string['sign_certinfo_org'] = 'Organization';
$string['sign_certinfo_valid'] = 'Validity';
$string['sign_certinfonocert'] = 'No certificate uploaded or password not set.';
$string['sign_certpassword'] = 'Certificate Password';
$string['sign_certpassword_help'] = 'Password to unlock the PFX/P12 certificate.';
$string['sign_gen_btn'] = 'Generate Self-Signed Certificate';
$string['sign_gen_cn'] = 'Common Name (CN)';
$string['sign_gen_country'] = 'Country (2-letter code)';
$string['sign_gen_generate'] = 'Generate and Install';
$string['sign_gen_heading'] = 'Would you like to generate a new self-signed certificate?';
$string['sign_gen_heading_desc'] = 'If you do not have a PFX/P12 file, the system can generate a self-signed certificate valid for 10 years.';
$string['sign_gen_org'] = 'Organization';
$string['sign_gen_password'] = 'Certificate Password';
$string['sign_gen_password_confirm'] = 'Confirm Password';
$string['sign_gen_password_weak'] = 'Password must be at least 4 characters.';
$string['sign_gen_passwords_mismatch'] = 'Passwords do not match.';
$string['sign_gen_success'] = 'Self-signed certificate generated and installed successfully.';
$string['sign_gen_title'] = 'Generate Self-Signed Certificate';
$string['sign_pfxfile'] = 'PFX/P12 Certificate';
$string['sign_pfxfile_help'] = 'Upload your PFX or P12 digital certificate file.';
$string['sign_reason'] = 'Signing Reason';
$string['sign_reason_help'] = 'Reason displayed in the signature (ex.: "Course Certificate").';
$string['sign_settings_heading'] = 'Digital Certificate Signing';
$string['sign_settings_heading_desc'] = 'Configure digital signing of generated certificate PDFs using a PFX/P12 certificate (PKCS#7 detached).';
$string['sign_task_interval'] = 'Signing task interval';
$string['sign_task_interval_help'] = 'How often the scheduled task processes pending certificates. Default: 2 minutes.';
$string['task_sign'] = 'Sign pending certificates digitally';
