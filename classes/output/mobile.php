...
namespace mod_certificatebeautiful\output;
...
/**
 * Output Mobile for mod_certificatebeautiful.
 *
    ...
    public static function mobile_course_view($args) {
        ...
        return [
            "templates" => [
                [
                    "id" => "main",
                    "html" => $OUTPUT->render_from_template("mod_certificatebeautiful/mobile", $data),
                ],
            ],
            "javascript" => "",
            "otherdata" => "",
